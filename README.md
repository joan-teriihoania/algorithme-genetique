...
> **Mots clés :** `algorithme`, `génétique`, `évolution`, `simulation`, `informatique`
...
1. **Aléatoire simple** : On sélectionne les individus de manière totalement aléatoire. Elle permet d'obtenir une sélection difforme et variée et d'ainsi varier les individus qui suivront.
